...
public class OrderController {
	...
	public void addItem(@PathVariable("id") Long id, @PathVariable("itemId") Long itemId, @RequestBody Integer quantity)throws AmanException {
		orderService.addItem(id, itemId, quantity);
	}
	
	@RequestMapping(value = "/{id}/pay", method = RequestMethod.PUT)
	public Receipt pay(@PathVariable("id") Long id, @RequestBody BigDecimal payment) throws AmanException {
